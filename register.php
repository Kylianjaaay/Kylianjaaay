...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "RegisterForm")) {
  $insertSQL = sprintf("INSERT INTO register (firstname, lastname, email, username, password) VALUES (%s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString($_POST['User Name'], "text"),
        ...
        <table width="300" border="0" align="center">
          <tr>
            <td><h3><span id="sprytextfield1">
              ...
              First Name:<br />
              <input name="First Name" type="text" class="ppf" id="First Name" />
            </span></h3>
            <span><span class="textfieldRequiredMsg">Fill in!</span></span></td>
            <td><h3><span id="sprytextfield2">
              <label for="Last Name"></label>
              LastName:<br />
              <input name="Last Name" type="text" class="ppf" id="Last Name" />
            </span></h3>
            <span><span class="textfieldRequiredMsg">Fill In!</span></span></td>
          </tr>
          <tr>
            <td><h3><span id="sprytextfield3">
              ...
              Username:<br />
              <input name="User Name" type="text" class="ppf" id="User Name" />
</span></h3>
            <span><span class="textfieldRequiredMsg">Fill in!</span></span></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td><h3><span id="sprytextfield4">
              ...
              E-mail:<br />
              <input name="E-mail" type="text" class="ppf" id="E-mail" />
...
<input name="Password" type="password" class="ppf" id="Password" />
            ...
            <span><span class="passwordRequiredMsg">Fill in!</span></span></td>
            <td><h3><span id="spryconfirm1">
              <label for="=Re-Enter Password"></label>
              Re-Enter Password:
              <input name="Re- Enter Password" type="password" class="ppf" id="ConfirmPassword" />
            </span></h3>
            <span><span class="confirmRequiredMsg">Fil In!</span><span class="confirmInvalidMsg">The values don't match.</span></span></td>
          </tr>
          <tr>
